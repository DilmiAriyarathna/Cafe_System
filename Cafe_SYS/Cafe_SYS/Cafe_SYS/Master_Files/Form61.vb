...
Public Class Form61
    ...
    Private Sub ComboBox1_TextChanged(sender As Object, e As EventArgs) Handles ComboBox1.TextChanged
        conn = GetConnect()
        conn.Open()
        SQL = "select * from Sub_Cat where Name ='" + ComboBox1.Text + "'"
    ...
    Private Sub TextBox8_TextChanged(sender As Object, e As EventArgs) Handles TextBox8.TextChanged
        conn = GetConnect()
        conn.Open()
        SQL = "select * from Main_Cat where code ='" + TextBox8.Text + "'"
        cmd = New SqlCommand(SQL, conn)
        dr = cmd.ExecuteReader
        While (dr.Read())
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf TextBox8.Text <> "" Or TextBox9.Text <> "" And TextBox2.Text = "" Then
            ...
            If TextBox8.Text <> "" And TextBox9.Text = "" Then
                conn = GetConnect()
                conn.Open()
                SQL = "update Sub_Cat set M_cat='" + TextBox8.Text + "' where Id='" + TextBox4.Text + "' " &
            ...
            ElseIf TextBox9.Text <> "" And TextBox8.Text = "" Then
                conn = GetConnect()
                conn.Open()
                SQL = "update Sub_Cat set M_cat='" + TextBox9.Text + "' where Id='" + TextBox4.Text + "' " &
        ...
        ElseIf TextBox8.Text <> "" Or TextBox9.Text <> "" And TextBox2.Text <> "" Then
            ...
            If TextBox8.Text <> "" And TextBox2.Text <> "" Then
                conn = GetConnect()
                conn.Open()
                SQL = "update Sub_Cat set Name='" + TextBox2.Text + "' , M_cat='" + TextBox8.Text + "' where Id='" + TextBox4.Text + "' " &
            ...
            ElseIf TextBox9.Text <> "" And TextBox2.Text <> "" Then
                conn = GetConnect()
                conn.Open()
                SQL = "update Sub_Cat set Name='" + TextBox2.Text + "' , M_cat='" + TextBox9.Text + "' where Id='" + TextBox4.Text + "' " &
                    "and code = '" + TextBox5.Text + "'"
                cmd = New SqlCommand(SQL, conn)
                cmd.ExecuteNonQuery()
                MsgBox("Successfully Updated !")
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        conn = GetConnect()
        conn.Open()
        SQL = "delete from Sub_Cat where Id='" + TextBox4.Text + "' " &
            "and code = '" + TextBox5.Text + "'"
        cmd = New SqlCommand(SQL, conn)
        cmd.ExecuteNonQuery()
    ...
    Private Sub ComboBox3_TextChanged(sender As Object, e As EventArgs) Handles ComboBox3.TextChanged
        conn = GetConnect()
        conn.Open()
        SQL = "select * from Main_Cat where Name ='" + ComboBox3.Text + "'"
        cmd = New SqlCommand(SQL, conn)
        dr = cmd.ExecuteReader
        While (dr.Read())
    ...
    Private Sub ComboBox2_TextChanged(sender As Object, e As EventArgs) Handles ComboBox2.TextChanged
        conn = GetConnect()
        conn.Open()
        SQL = "select * from Main_Cat where Name ='" + ComboBox2.Text + "'"
        cmd = New SqlCommand(SQL, conn)
        dr = cmd.ExecuteReader
        While (dr.Read())
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If Not ComboBox2.Text = "" Then
            If Not TextBox1.Text = "" Then
                conn = GetConnect()
                conn.Open()
                SQL = "insert into Sub_Cat(id,code,Name,M_cat) values ('" + TextBox6.Text + "', " &
    ...
    Private Sub Form61_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        conn = GetConnect()
        conn.Open()
        SQL = "select Count(Id) from Sub_Cat"
        cmd = New SqlCommand(SQL, conn)
        Try
            dr = cmd.ExecuteReader
            While dr.Read
