...
Public Class Form6
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If Not TextBox1.Text = "" Then
            conn = GetConnect()
            conn.Open()
            SQL = "insert into Main_Cat(id,code,Name) values ('" + TextBox6.Text + "', " &
    ...
    Private Sub Form6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        conn = GetConnect()
        conn.Open()
        SQL = "select Count(Id) from Main_Cat"
        cmd = New SqlCommand(SQL, conn)
        Try
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Not TextBox2.Text = "" Then
            conn = GetConnect()
            conn.Open()
            SQL = "update Main_Cat set Name = '" + TextBox2.Text + "' where Id='" + TextBox4.Text + "' " &
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If Not TextBox4.Text = "" Then
            conn = GetConnect()
            conn.Open()
            SQL = "delete from Main_Cat where Id='" + TextBox4.Text + "' " &
                "and code = '" + TextBox5.Text + "'"
            cmd = New SqlCommand(SQL, conn)
            cmd.ExecuteNonQuery()
    ...
    Private Sub ComboBox1_TextChanged(sender As Object, e As EventArgs) Handles ComboBox1.TextChanged
        conn = GetConnect()
        conn.Open()
        SQL = "select * from Main_Cat where Name ='" + ComboBox1.Text + "'"
        cmd = New SqlCommand(SQL, conn)
        dr = cmd.ExecuteReader
        While (dr.Read())
